...
def train():
    ...
    # Loop iterations execution block
    ...
    model_trained = True
    return jsonify({"message": "Training complete", "samples": len(X)})

# ── PREDICT (Corrected Path Rule) ──────────────────────
